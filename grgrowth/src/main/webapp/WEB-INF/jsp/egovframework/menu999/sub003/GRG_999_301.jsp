...
<div id="container" style="width: 900px; margin: 0 auto;">
	...
	<div id="post-7242" class="post-7242 page type-page status-publish hentry entry">
		<div id="divSitemap">
			<div id="smTitle">
			...
			<div class="smap-3" style="width: 180px;">
				...
				<ul>
					...
					<li><a href="<c:url value="/menu003/sub004/GRG_003_401.do" />">관련사이트</a></li>
				</ul>
			</div>
			...
			<div class="smap-4" style="width: 200px;">
				...
				<ul>
					...
					<li><a href="<c:url value="/menu004/sub005/GRG_004_501.do" />">위원회 로고</a></li>
				</ul>
			</div>
		</div>
		<div class="clear"></div>

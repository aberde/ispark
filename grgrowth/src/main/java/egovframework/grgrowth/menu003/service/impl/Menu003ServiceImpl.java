...
/**
 * 정보 CRUD 요청을 처리하는 비즈니스 클래스
 */
@Service("menu003Service")
public class Menu003ServiceImpl implements Menu003Service {

	@Resource(name = "menu003Mapper")
	private Menu003Mapper menu003Mapper;
    ...
    public List<CommonBoardVO> dicList(CommonBoardVO vo) throws Exception {
        return menu003Mapper.dicList(vo);
    }
    ...
    public int dicListTotCnt(CommonBoardVO vo) throws Exception {
        return menu003Mapper.dicListTotCnt(vo);
    }
}
